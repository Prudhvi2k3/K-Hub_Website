...
const ManageAchievement = () => {
  ...
  const handleSave = async (id) => {
    ...
    try {
      ...
      const response = await axios.put(`https://k-hub-website-fywagmopb-prudhvis-projects-a7c78c11.vercel.app/api/achievements/${id}`, formData, {
        headers: {
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://k-hub-website-fywagmopb-prudhvis-projects-a7c78c11.vercel.app/api/achievements/${id}`);
