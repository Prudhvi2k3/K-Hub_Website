...
const ManageNews = () => {
  ...
  const handleDelete = async () => {
    if (window.confirm('Are you sure you want to delete this news item?')) {
      try {
        await axios.delete(`https://k-hub-website-fywagmopb-prudhvis-projects-a7c78c11.vercel.app/api/news/${selectedNews._id}`);
        fetchNews();
  ...
  const handleSave = async () => {
    try {
      ...
      await axios.put(`https://k-hub-website-fywagmopb-prudhvis-projects-a7c78c11.vercel.app/api/news/${editedNews._id}`, formData, {
        headers: {
