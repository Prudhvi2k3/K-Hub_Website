...
const EventManager = () => {
    ...
    const fetchEvents = async () => {
        try {
            const response = await axios.get('https://k-hub-website-fywagmopb-prudhvis-projects-a7c78c11.vercel.app/api/events');
    ...
    const handleEventClick = async (eventId) => {
        try {
            const response = await axios.get(`https://k-hub-website-fywagmopb-prudhvis-projects-a7c78c11.vercel.app/api/events/${eventId}`);
    ...
    const handleDeleteEvent = async (eventId) => {
        try {
            await axios.delete(`https://k-hub-website-fywagmopb-prudhvis-projects-a7c78c11.vercel.app/api/events/${eventId}`);
            fetchEvents();
    ...
    const handleDeleteSubEvent = async (eventId, subEventId) => {
        try {
            await axios.delete(`https://k-hub-website-fywagmopb-prudhvis-projects-a7c78c11.vercel.app/api/events/${eventId}/subevents/${subEventId}`);
            const updatedEventResponse = await axios.get(`https://k-hub-website-fywagmopb-prudhvis-projects-a7c78c11.vercel.app/api/events/${eventId}`);
    ...
    const handleDeleteImage = async (eventId, subEventId, imageId) => {
        try {
            await axios.delete(`https://k-hub-website-fywagmopb-prudhvis-projects-a7c78c11.vercel.app/api/events/${eventId}/subevents/${subEventId}/images/${imageId}`);
            const updatedEventResponse = await axios.get(`https://k-hub-website-fywagmopb-prudhvis-projects-a7c78c11.vercel.app/api/events/${eventId}`);
            setSelectedEvent(updatedEventResponse.data);
            fetchEvents();
        } catch (error) {
    ...
    const handleEditEvent = async (eventId, updatedData) => {
        try {
            ...
            const response = await axios.put(`https://k-hub-website-fywagmopb-prudhvis-projects-a7c78c11.vercel.app/api/events/${eventId}`, formData, {
                headers: {
    ...
    const handleEditSubEvent = async (eventId, subEventId, updatedData) => {
        try {
            ...
            const response = await axios.put(`https://k-hub-website-fywagmopb-prudhvis-projects-a7c78c11.vercel.app/api/events/${eventId}/subevents/${subEventId}`, formData, {
                headers: {
                    'Content-Type': 'multipart/form-data'
                }
            });
